(function () {
    ...
    if (localStorage.rixzortl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "/backend/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "/backend/assets/libs/bootstrap/css/bootstrap.min.css");
    }
