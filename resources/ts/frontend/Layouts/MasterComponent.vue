                  ...
                  <div class="row">
                    ...
                    <div class="col-6 text-end d-flex align-items-end">
                      <div class="card-body pb-0 pt-7">
                        <img src="/backend/assets/img/illustrations/card-ratings-illustration.png" alt="Ratings"
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="card h-100">
                  <div class="row">
                    ...
                    <div class="col-6 text-end d-flex align-items-end">
                      <div class="card-body pb-0 pt-7">
                        <img src="/backend/assets/img/illustrations/card-session-illustration.png" alt="Ratings"
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide pb-5">
                      <div class="row">
                        ...
                        <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                          <img src="/backend/assets/img/products/card-weekly-sales-phone.png" alt="weekly sales"
                    ...
                    <div class="swiper-slide pb-5">
                      <div class="row">
                        ...
                        <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                          <img src="/backend/assets/img/products/card-weekly-sales-controller.png" alt="weekly sales"
                            width="230" class="weekly-sales-img">
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide pb-5">
                      <div class="row">
                        ...
                        <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                          <img src="/backend/assets/img/products/card-weekly-sales-watch.png" alt="weekly sales"
                            width="230" class="weekly-sales-img">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="timeline-event">
                          ...
                          <div class="d-flex align-items-center mb-1">
                            <div class="badge bg-lighter rounded-3">
                              <img src="/backend/assets/img/icons/misc/pdf.png" alt="img" width="15" class="me-2">
                          ...
                          <div class="d-flex justify-content-between flex-wrap gap-2">
                            <div class="d-flex flex-wrap align-items-center">
                              <div class="avatar avatar-sm me-2">
                                <img src="/backend/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle">
                              </div>
                              <div>
                              ...
                              <div class="d-flex flex-wrap align-items-center">
                                <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                  <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    ...
                                    <img class="rounded-circle" src="/backend/assets/img/avatars/5.png" alt="Avatar">
                                  </li>
                                  <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    title="Allen Rieske" class="avatar pull-up">
                                    <img class="rounded-circle" src="/backend/assets/img/avatars/12.png" alt="Avatar">
                                  </li>
                                  <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    title="Julee Rossignol" class="avatar pull-up">
                                    <img class="rounded-circle" src="/backend/assets/img/avatars/6.png" alt="Avatar">
                                  </li>
                                  <li class="avatar">
                    ...
                    <ul class="nav nav-tabs nav-tabs-widget pb-6 gap-4 mx-1 d-flex flex-nowrap align-items-center"
                      ...
                      <li class="nav-item">
                        <a href="javascript:void(0);"
                          ...
                          <div>
                            <img src="/backend/assets/img/products/apple-iPhone-13.png" alt="Mobile" class="img-fluid">
                          </div>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="javascript:void(0);"
                          ...
                          aria-selected="false">
                          <div>
                            <img src="/backend/assets/img/products/apple-iMac-3k.png" alt="Apple iMac 3k"
                              class="img-fluid">
                          </div>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="javascript:void(0);"
                          ...
                          aria-selected="false">
                          <div>
                            <img src="/backend/assets/img/products/gaming-remote.png" alt="Gaming Remote"
                              class="img-fluid">
                          </div>
                        </a>
                      </li>
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table border-top">
                          ...
                          <tbody class="table-border-bottom-0">
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/samsung-s22.png" alt="Mobile" width="34" height="34"
                                  class="rounded">
                              </td>
                              <td>Samsung s22</td>
                              <td class="text-end">
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/apple-iPhone-13-pro.png" alt="Mobile" width="34"
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/oneplus-9-pro.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                              <td>Oneplus 9 Pro</td>
                              <td class="text-end">
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/google-pixel-6.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table border-top">
                          ...
                          <tbody class="table-border-bottom-0">
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/apple-mac-mini.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/hp-envy-x360.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/dell-inspiron-3000.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/apple-iMac-4k.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                              <td>Apple iMac 4k</td>
                              <td class="text-end">
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table border-top">
                          ...
                          <tbody class="table-border-bottom-0">
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/sony-play-station-5.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/xbox-series-x.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                              <td>XBOX Series X</td>
                              <td class="text-end">
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/nintendo-switch.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="/backend/assets/img/products/sup-game-box-400.png" alt="Mobile" width="34"
                                  height="34" class="rounded">
                              </td>
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div>
                        <div class="chart-progress" data-color="primary" data-series="70"
                          data-icon="/backend/assets/img/icons/misc/card-icon-laptop.png"></div>
                      </div>
                      <div>
                        <div class="card-info">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div>
                        <div class="chart-progress" data-color="warning" data-series="40"
                          data-icon="/backend/assets/img/icons/misc/card-icon-bag.png"></div>
                      </div>
                      <div>
                        <div class="card-info">
                          <div class="d-flex align-items-center gap-2 flex-wrap">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide card pb-5 shadow-none border-0">
                      ...
                      <div class="d-flex align-items-center mt-5">
                        <img src="/backend/assets/img/products/card-marketing-expense-logo.png" alt="Marketing and sales"
                      ...
                      <div class="mt-6">
                        <button type="button" class="btn btn-sm btn-outline-primary me-3"><i
                            class="tf-icons ri-sticky-note-line ri-14px me-1"></i>Details</button>
                        <button type="button" class="btn btn-sm btn-primary"><i
                            class="tf-icons ri-download-line ri-14px me-1"></i>Report</button>
                      </div>
                    </div>
                    <div class="swiper-slide card pb-5 shadow-none border-0">
                      <h5 class="mb-1">Marketing & Sales</h5>
                      ...
                      <div class="d-flex align-items-center mt-5">
                        <img src="/backend/assets/img/products/card-accounting-logo.png" alt="Marketing and sales"
                          width="84" class="rounded-4">
                        <div class="d-flex flex-column w-100 ms-6">
                    ...
                    <div class="swiper-slide card pb-5 shadow-none border-0">
                      ...
                      <div class="d-flex align-items-center mt-5">
                        <img src="/backend/assets/img/products/card-sales-overview-logo.png" alt="Marketing and sales"
                          width="84" class="rounded-4">
                        <div class="d-flex flex-column w-100 ms-6">
